        ...
        return (
            <div className="card">
                <div className="card-header">
                    <a data-toggle="collapse" href="#customer-info" aria-expanded="true" aria-controls="customer-info"><i className="fa fa-align-justify"></i></a> Customer Information - <span>{store.salesQuotation.customerId}</span>
                </div>
