...
/***/ 0:
/*!**********************************************************!*\
  !*** ./wwwroot/libs/tsxbuild/financials/journalentry.js ***!
  \**********************************************************/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SelectVoucherType = (function (_super) {
	    ...
	    SelectVoucherType.prototype.render = function () {
	        ...
	        return (React.createElement("select", {id: this.props.controlId, value: this.props.selected, onChange: this.onChangeVoucherType.bind(this), className: "form-control select2"}, React.createElement("option", {key: -1, value: ""}), options));
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SelectVoucherType = (function (_super) {
	    ...
	    SelectVoucherType.prototype.render = function () {
	        ...
	        return (React.createElement("select", {value: this.props.selected, id: this.props.controlId, onChange: this.onChangeAccount.bind(this), className: "form-control select2"}, React.createElement("option", {key: -1, value: ""}), options));
	    };
	    SelectVoucherType = __decorate([
	        mobx_react_1.observer
	    ], SelectVoucherType);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SelectDebiCredit = (function (_super) {
	    ...
	    SelectDebiCredit.prototype.render = function () {
	        ...
	        return (React.createElement("select", {id: this.props.controlId, value: this.props.selected, onChange: this.onChangeDebitCredit.bind(this), className: "form-control select2"}, React.createElement("option", {key: -1, value: ""}), options));
	    };
...
//# sourceMappingURL=journalentry.chunk.js.map