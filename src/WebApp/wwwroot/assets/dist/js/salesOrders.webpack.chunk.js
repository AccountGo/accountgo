...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'td',
	                null,
	                this.props.salesorder.OrderDate
	            ),
	            React.createElement(
	                'td',
	                null,
	                this.props.salesorder.TotalAmount
	            )
	        );
	    }
	});
	...
	var SalesOrdersTable = React.createClass({
	    ...
	    render: function render() {
	        var rows = this.state.salesorders.map(function (salesorder) {
	            return React.createElement(SalesOrderRow, { key: salesorder.Id, salesorder: salesorder });
	        });
	        return React.createElement(
	            'div',
	            ...
	            React.createElement(
	                'table',
	                { 'class': 'table table-bordered', id: 'tblSalesOrder' },
	                React.createElement(
	                    'thead',
	                    null,
	                    React.createElement(
	...
	ReactDOM.render(React.createElement(SalesOrdersTable, { dataUrl: 'http://localhost:44320/api/sales/getsalesorders' }), document.getElementById('griddata'));
