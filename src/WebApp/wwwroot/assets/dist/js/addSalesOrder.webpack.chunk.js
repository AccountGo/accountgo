...
/***/ function(module, exports, __webpack_require__) {
	...
	var CustomerSelector = __webpack_require__(169);
	var ItemSelector = __webpack_require__(170);
	...
	var SalesOrderItemsCell = React.createClass({
	    displayName: 'SalesOrderItemsCell',

	    handleChange: function handleChange(evt) {
	        this.props.onChange(evt.target.value);
	    },
	    render: function render() {
	        return React.createElement('input', { value: this.props.value, onChange: this.handleChange });
	    }
	});

	var SalesOrderItemsRow = React.createClass({
	    displayName: 'SalesOrderItemsRow',

	    onRowDeleteEvent: function onRowDeleteEvent() {
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'td',
	                null,
	                React.createElement(ItemSelector, { selectedValue: this.props.lineItem.itemId, items: this.props.items, onChange: this.handleChange.bind(null, "itemId") })
	            ),
	            React.createElement(
	                'td',
	                null,
	                React.createElement(SalesOrderItemsCell, { value: this.props.lineItem.quantity, onChange: this.handleChange.bind(null, "quantity") })
	            ),
	            React.createElement(
	                'td',
	                null,
	                React.createElement('input', { type: 'button', id: 'btnDeleteLineItem', value: 'Delete', onClick: this.onRowDeleteEvent })
	            )
	        );
	    }
	});
	...
	var SalesOrderItems = React.createClass({
	    displayName: 'SalesOrderItems',

	    handleAddLineItem: function handleAddLineItem() {
	    ...
	    render: function render() {
	        var items = this.props.lineItems.map(function (lineItem, index) {
	            return React.createElement(SalesOrderItemsRow, { key: index, lineItem: lineItem, items: this.props.items, onRowDelete: this.props.onRowDelete.bind(null, index), onCellChange: this.props.onCellChange.bind(null, index) });
	        }, this);
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'td',
	                        null,
	                        React.createElement(ItemSelector, { id: 'optItemId', items: this.props.items })
	                    ),
	                    React.createElement(
	                        'td',
	                        null,
	                        React.createElement('input', { type: 'text', id: 'txtQuantity' })
	                    ),
	                    React.createElement(
	                        'td',
	                        null,
	                        React.createElement('input', { type: 'button', id: 'btnAdd', value: 'Save', onClick: this.handleAddLineItem })
	                    )
	                )
	            )
	        );
	...
	var SalesOrderHeader = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            null,
	            'Order Date: ',
	            this.props.header.orderDate,
	            React.createElement('br', null),
	            'Customer :',
	            React.createElement(CustomerSelector, { selectedValue: this.props.header.customerId, customers: this.props.customers, id: 'optCustomer' })
	        );
	    }
	});

	var SalesOrderForm = React.createClass({
	    displayName: 'SalesOrderForm',
	    ...
	    handleAddLineItem: function handleAddLineItem(newlineItems) {
	    ...
	    handleSubmitSuccess: function handleSubmitSuccess(data) {
	        //if (data.status == 'ok') {
	    ...
	    handleSubmitFailure: function handleSubmitFailure(xhr, ajaxOptions, thrownError) {
	        //this.setState({
	    ...
	    handleRowDelete: function handleRowDelete(index) {
	        //"_" is sometimes used to represent an unused argument. Here, it's the current item in the array.
	        this.setState({
	            lineItems: this.state.lineItems.filter(function (_, i) {
	                return i !== index;
	            })
	        });
	    },

	    handleLineItemCellChange: function handleLineItemCellChange(rowIdx, prop, val) {
	    ...
	    render: function render() {
	        return React.createElement(
	            'form',
	            { id: 'frmAddSalesOrder', onSubmit: this.handleOnSubmit, action: 'sales/addsalesorder' },
	            React.createElement(SalesOrderHeader, { header: this.state.salesOrder, customers: this.state.customers }),
	            React.createElement(SalesOrderItems, { lineItems: this.state.lineItems, items: this.state.items, updatelineItems: this.handleAddLineItem, onRowDelete: this.handleRowDelete, onCellChange: this.handleLineItemCellChange }),
	            React.createElement(SaveSalesOrderForm, null)
	        );
	    }
	});

	var SaveSalesOrderForm = React.createClass({
	    displayName: 'SaveSalesOrderForm',

	    render: function render() {
	        return React.createElement('input', { type: 'submit', id: 'btnSave', value: 'Save Order' });
	    }
	});

	ReactDOM.render(React.createElement(SalesOrderForm, { modelUrl: 'sales/getaddsalesordermodel' }), document.getElementById('addsalesorderform'));
	...
	var CustomerSelector = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'select',
	                { defaultValue: this.props.selectedValue, onChange: this.handleChange, id: this.props.id },
	                options
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ItemSelector = React.createClass({
	    ...
	    handleChange: function handleChange(evt) {
	        if (evt.target.id == null) this.props.onChange(evt.target.value);
	    },
	    render: function render() {
