CREATE TABLE [dbo].[PurchaseOrderLine] (
    ...
    CONSTRAINT [FK_dbo.PurchaseOrderLine_dbo.Item_ItemId] FOREIGN KEY ([ItemId]) REFERENCES [dbo].[Item] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_dbo.PurchaseOrderLine_dbo.Measurement_MeasurementId] FOREIGN KEY ([MeasurementId]) REFERENCES [dbo].[Measurement] ([Id]) ON DELETE CASCADE,
